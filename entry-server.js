...
import React__default, { Component, useEffect, useState } from "react";
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  if (locationArg) {
    ...
    !(parentPathnameBase === "/" || ((_parsedLocationArg$pa = parsedLocationArg.pathname) == null ? void 0 : _parsedLocationArg$pa.startsWith(parentPathnameBase))) ? process.env.NODE_ENV !== "production" ? invariant$1(false, "When overriding the location using `<Routes location>` or `useRoutes(routes, location)`, the location pathname must begin with the portion of the URL pathname that was " + ('matched by all parent routes. The current pathname base is "' + parentPathnameBase + '" ') + ('but pathname "' + parsedLocationArg.pathname + '" was given in the `location` prop.')) : invariant$1(false) : void 0;
...
function _renderMatches(matches, parentMatches, dataRouterState, future) {
  ...
  if (errors != null) {
    ...
    !(errorIndex >= 0) ? process.env.NODE_ENV !== "production" ? invariant$1(false, "Could not find a matching route for errors on route IDs: " + Object.keys(errors).join(",")) : invariant$1(false) : void 0;
...
function useRouteContext(hookName) {
  ...
  !route ? process.env.NODE_ENV !== "production" ? invariant$1(false, getDataRouterConsoleError(hookName)) : invariant$1(false) : void 0;
  return route;
}
...
function Router$1(_ref5) {
  ...
  !!useInRouterContext() ? process.env.NODE_ENV !== "production" ? invariant$1(false, "You cannot render a <Router> inside another <Router>. You should never have more than one in your app.") : invariant$1(false) : void 0;
...
function createRoutesFromChildren(children, parentPath) {
  ...
  React.Children.forEach(children, (element, index) => {
    ...
    !(element.type === Route) ? process.env.NODE_ENV !== "production" ? invariant$1(false, "[" + (typeof element.type === "string" ? element.type : element.type.name) + "] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>") : invariant$1(false) : void 0;
    !(!element.props.index || !element.props.children) ? process.env.NODE_ENV !== "production" ? invariant$1(false, "An index route cannot have child routes.") : invariant$1(false) : void 0;
    let route = {
...
const HeaderNavigationBar = () => {
  return /* @__PURE__ */ jsxs("section", { className: "flex justify-start bg-gray-800 p-2.5 w-full", children: [
    /* @__PURE__ */ jsx(
      "a",
      {
        href: "/",
...
const Home = () => {
  ...
  const pageDescription = "Welcome to our website — your second home. Discover engaging content and quality services. Home, sweet home 🏠";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Helmet, { children: [
      ...
      /* @__PURE__ */ jsx("meta", { name: "author", content: "Our Website Team" }),
      ...
      /* @__PURE__ */ jsx("meta", { property: "og:site_name", content: "Our Website" }),
    ...
    /* @__PURE__ */ jsx(BaseLayout, { children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-8 text-center", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-4", children: "Welcome to Our Homepage" }),
      /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-700 mb-2", children: "Home, sweet home 🏠" }),
      /* @__PURE__ */ jsx("p", { className: "text-md text-gray-600", children: "This is the main content of the homepage, optimized for SEO and designed to make a great first impression." })
    ] }) })
  ] });
};
const About = () => {
  const pageTitle = "About Us - Our Website | Meet the Team";
  const pageDescription = "Learn more about us — our history, vision, and the dedicated team ready to serve you with excellence.";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(BaseLayout, { children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-8", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-4", children: "About Us" }),
      /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-700", children: "We are a team of experienced and passionate professionals." }),
      /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-700", children: "Our mission is to serve you with the highest quality and care." })
    ] }) })
  ] });
};
const Contact = () => {
  const pageTitle = "Contact Us - Our Website | Get in Touch";
  const pageDescription = "Reach out to us via phone, email, or visit our office. We're happy to assist with any inquiries.";
  ...
  const jsonLd = {
    ...
    "@type": "ContactPage",
    name: "Contact Us",
    description: "Contact page with information on how to reach our team via phone, email, or in person.",
    url: pageUrl
  };
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(BaseLayout, { children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-8", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-4", children: "Contact Us" }),
      /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-700 mb-2", children: "We’d love to hear from you! You can reach us through any of the following methods:" }),
      /* @__PURE__ */ jsxs("ul", { className: "text-md text-gray-600 space-y-2", children: [
        ...
        /* @__PURE__ */ jsxs("li", { children: [
          ...
          " 123 Sukhumvit Road, Bangkok 10110, TH"
        ] }),
        /* @__PURE__ */ jsxs("li", { children: [
          /* @__PURE__ */ jsx("strong", { children: "Office Hours:" }),
...
function Error$1({ statusCode }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h1", { children: "Where have you gone, Joe DiMaggio?" }),
    /* @__PURE__ */ jsx("p", { children: "Break on through to the Wildcard side." }),
...
const Router = () => {
  return /* @__PURE__ */ jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsx(Route, { path: "/contactUs", element: /* @__PURE__ */ jsx(Contact, {}) }),
    /* @__PURE__ */ jsx(Route, { path: "*", element: /* @__PURE__ */ jsx(Error$1, { statusCode: 404 }) })
  ] });
};
function render(url, options = {}) {
  ...
  if (statusCode) {
    return {
      html: ReactDOMServer.renderToString(/* @__PURE__ */ jsx(Error$1, { statusCode })),
      head: ""
    };
  }
  const helmetContext = {};
  ...
  const html = ReactDOMServer.renderToString(
    /* @__PURE__ */ jsx(React__default.StrictMode, { children: /* @__PURE__ */ jsx(HelmetProvider, { context: helmetContext, children: /* @__PURE__ */ jsx(StaticRouter, { location: url, children: /* @__PURE__ */ jsx(Router, {}) }) }) })
  );
